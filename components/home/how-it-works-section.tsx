...
const steps: Steps[] = [
    ...
    },
    {
        ...
        label: 'AI Analysis',
        description: 'Our advanced AI processes and anayzes your document instantly',
    },
    {
    ...
    <section className="relative overflow-hidden bg-gray-50">
        <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                -translate-x-1/2 bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500
...
function StepItem({ icon, label, description }: Steps) {
    return <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border
    border-white/10 hover:border-blue-500/5 transition-colors group w-full">
