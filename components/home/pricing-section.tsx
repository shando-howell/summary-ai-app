                ...
                <div className="flex justify-between items-center gap-4">
                    <div>
                        ...
                        <div className="space-y-2 flex justify-center w-full">
                            <Link 
                                href={paymentLink}
                                className={cn("w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-blue-800 to-blue-500 hover:from-blue-500 hover:to-blue-800 text-white border-2 py-2",
                                id === 'pro' 
                                    ? 'border-blue-900' 
    ...
    <section className="relative overflow-hidden" id="pricing">
        <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
            <div className="flex items-center justify-center w-full pb-12">
                <h2 className="uppercase font-bold text-xl mn-8 text-blue-500">Pricing</h2>
            </div>
